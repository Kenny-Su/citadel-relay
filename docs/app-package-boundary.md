...
- First-party local app runtime descriptors are generated from package `citadel` metadata by `scripts/generate-local-app-metadata.mjs`; package `manifest.ts` files are aliases, not hand-written metadata copies.
