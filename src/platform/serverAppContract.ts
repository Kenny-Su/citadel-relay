...
export type ServerAppFactory<TServices> = (services: TServices) => ServerAppModule;
...
export type ServerAppProtocolExport<TServices> =
  | ServerAppFactory<TServices>
  | ServerAppModule
  | ServerAppBundle<TServices>
  | ServerAppRegistration<TServices>;
